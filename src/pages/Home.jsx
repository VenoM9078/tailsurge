        ...
        <div className="relative container m-auto px-6 md:px-12 lg:px-6">
          <div className="mb-12 pt-28 lg:w-9/12 lg:mx-auto">
            <a
              ...
              className="inline-flex mb-6 justify-between items-center  py-1 px-1 pr-4 text-sm text-gray-900 bg-purple-200 rounded-full bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40 border border-gray-100  hover:bg-purple-200"
            >
              <span className="text-xs bg-gradient-to-tr from-purple-500 to-pink-300 rounded-full text-white px-4 py-1.5 mr-3">
                New
              </span>{" "}
              <span className="text-sm font-medium">
                We are launching Sand API - another solo adventure to make APIs
                easy for you!
              </span>
              <svg
                aria-hidden="true"
