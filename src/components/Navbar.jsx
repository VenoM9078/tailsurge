              ...
              <div className="w-full flex justify-between lg:w-auto">
                ...
                >
                  <span
                    ...
                    className="inline bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-indigo-900 via-indigo-400 to-indigo-900 bg-clip-text font-bold text-2xl tracking-tight text-transparent "
                  >
                    TailSurge
                  </span>
                </Link>
